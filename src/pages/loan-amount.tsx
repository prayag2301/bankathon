        ...
        <Grid item xs={8}>
          ...
          >
            ...
            >
              ...
              >
                 You have unlocked your personal loan offer of 5,00,000/-
              </Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
      <Typography className={styles.amt}>₹5,00,000</Typography>
      <Typography className={styles.amtdes}>
        Rate of Interest:12.49% p.a
      </Typography>
      <Typography className={styles.amtdes2}>
        This offer is open for 10 mins ⏱
      </Typography>

      <Grid container style={{ marginTop: "40px" }} s>
        <Grid item xs={4}>
          <Avatar
            className={styles.ava}
            alt="Bot"
        ...
        <Grid item xs={8}>
          ...
          >
            ...
            >
              <Typography
                style={{ fontSize: "12px", marginTop: "2px", padding: "2px" }}
              >
                Your loan of ₹5,00,000 is sanctioned at 12.49% interest rate 💰
              </Typography>
              <Typography
                style={{ fontSize: "13px", color: "black", fontWeight: "700" }}
                variant="body2"
                color="text.secondary"
              >
                You can customise as per your needs.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
